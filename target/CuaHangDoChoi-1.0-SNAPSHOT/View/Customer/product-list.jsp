                                                                ...
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    ...
                                                                    <div class="product-description">
                                                                        ...
                                                                        <div class="product-buttons d-flex justify-content-center">
                                                                            ...
                                                                            <a href="${pageContext.request.contextPath}/productdetail?id=${pro.id}" class="quick-view hidden-sm-down" data-link-action="quickview">
                                                    ...
                                                    <div class="d-flex justify-content-around row">
                                                        ...
                                                        <div class="page-list col col-xs-12">
                                                            <ul>
                                                                <c:if test="${page != 1}">
                                                                    <li>
                                                                        <a rel="prev" href="productlist?index=${page-1}" class="disabled js-search-link"> <!-- Kích hoạt hoặc vô hiệu nút Trước -->
                                                                            Trước
                                                                        </a>
                                                                    </li>
                                                                </c:if>
                                                                <c:forEach begin = "1" end = "${end}" var = "i">
                                                                    <li class="${page == i?"current active":""}"> <!-- Tô đậm trang dùng toán tử 3 ngôi -->
                                                                        <a rel="nofollow" href="productlist?index=${i}" class="disabled js-search-link"> <!-- cẩn thận nhầm url -->
                                                                            ${i}
                                                                        </a>
                                                                    </li>
                                                                </c:forEach>
                                                                <c:if test="${page != end}">
                                                                    <li>
                                                                        <a rel="next" href="productlist?index=${page+1}"}" class="next disabled js-search-link"> <!-- Kích hoạt hoặc vô hiệu nút Trước -->
                                                                            Sau
                                                                        </a>
                                                                    </li>
                                                                </c:if>
